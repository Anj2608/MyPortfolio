...
export default function AboutUs() {
  return (
    <div className="bg-white/40 backdrop-blur-md w-full max-w-6xl mx-auto rounded-xl shadow-xl border border-white/40 px-6 sm:px-10 py-10">

      <h2 className="text-3xl sm:text-4xl font-bold text-center mb-10 text-pink-800">
        About Me
      </h2>
      ...
      <div className="flex flex-col md:flex-row items-center gap-10">
        ...
        <div className="w-full md:w-2/3 text-center md:text-left">
          ...
          <p className="text-white leading-relaxed mb-4 text-sm sm:text-base">
            I&#39;m Anjali, a passionate web developer from Jharkhand with experience
            in building responsive websites and dynamic web apps using React,
            Next.js, Node.js, and Tailwind CSS. I enjoy solving problems,
            learning new tools, and turning ideas into functional, refined
            digital experiences.
          </p>

          <h3 className="text-xl font-semibold mt-6 mb-3 text-pink-800">
            Tech Stack:
          </h3>

          <ul className="flex flex-wrap gap-3 text-xs sm:text-sm justify-center md:justify-start text-black">
            <li className="bg-white/70 px-3 py-1 rounded-full shadow">React</li>
            <li className="bg-white/70 px-3 py-1 rounded-full shadow">Next.js</li>
            <li className="bg-white/70 px-3 py-1 rounded-full shadow">Tailwind CSS</li>
            <li className="bg-white/70 px-3 py-1 rounded-full shadow">Node.js</li>
          ...
          <h3 className="text-xl font-semibold mt-6 mb-2 text-pink-800">
            Outside of Code:
          </h3>

          <p className="text-white text-sm sm:text-base">
            I enjoy reading books, drawing Mandala art, watching K-dramas, and
            listening to music. I’m self-driven and always working to grow as a
