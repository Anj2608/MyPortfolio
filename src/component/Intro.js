...
export default function Intro() {
  return (
    <div className="bg-white text-black mx-auto max-w-6xl rounded-md shadow-md px-4 sm:px-6 py-6 sm:py-8">

      <div className="flex flex-col md:flex-row items-center md:items-start gap-8">

        {/* Left Image */}
        <div className="w-full md:w-1/2 flex justify-center">
          <div className="relative w-64 h-64 sm:w-80 sm:h-80 md:w-full md:h-auto">
            <Image
              src="/anjali.jpg"
              alt="Intro"
              width={500}
        ...
        <div className="w-full md:w-1/2 text-center md:text-left">
          <h1 className="text-3xl sm:text-4xl font-bold mb-4 text-fuchsia-800">
            Hi 👋, I&#39;m Anjali
          </h1>
          ...
          <ReactTyped
            ...
            backSpeed={30}
            loop
            className="text-gray-800 text-xl sm:text-2xl md:text-3xl font-medium"
          />
          ...
          <p className="text-gray-700 leading-relaxed mt-4 text-sm sm:text-base">
            ...
            learning new tools, and turning ideas into functional, beautiful
            experiences.
          </p>

          <h3 className="text-lg sm:text-xl font-semibold mt-6 mb-3 text-fuchsia-800">
            Tech Stack:
          </h3>

          <ul className="flex flex-wrap gap-3 text-xs sm:text-sm justify-center md:justify-start">
            <li className="bg-white/70 px-3 py-1 rounded-full shadow">Javascript</li>
            <li className="bg-white/70 px-3 py-1 rounded-full shadow">React</li>
            <li className="bg-white/70 px-3 py-1 rounded-full shadow">Next.js</li>
            <li className="bg-white/70 px-3 py-1 rounded-full shadow">Tailwind CSS</li>
