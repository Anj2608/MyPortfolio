...
const experiences = [
  {
    title: "Full Stack Developer – Codedotart (2024)",
    description:
      "Worked on AR/VR and gaming platforms using React, Node.js, and Three.js. Built dynamic dashboards, integrated APIs, and developed responsive UI with Tailwind. Collaborated with designers and 3D teams to create immersive user experiences.",
  },
  {
    title: "Web Developer Intern – Dzinepixel Studio (2023)",
    description:
      "Developed a Travel Management System using PHP, MySQL, and HTML/CSS. Designed booking modules, secure authentication, admin panels, and automated reporting workflows.",
  },
];

const education = [
  {
    title: "MCA – College of Engineering Bhubaneswar (2021–2024)",
    description:
      "Focused on full-stack development, data structures, and database systems. Built multiple academic and personal projects.",
  },
  {
    title: "B.Sc Mathematics – Karim City College (2018–2021)",
    description:
      "Strengthened analytical and logical problem-solving skills essential for software development.",
  },
  {
    title: "Intermediate (PCM + CS) – CBSE (2016–2018)",
    description:
      "Studied Physics, Chemistry, Maths, and Computer Science. Early exposure to programming.",
  },
  {
    title: "Matriculation – CBSE (2016)",
    description:
      "Completed foundational education with distinction and active participation in tech events.",
  },
];
...
export default function MyResume() {
  const renderTimelineCard = (item, index) => {
    ...
    return (
      ...
      >
        {/* Timeline Dot */}
        <div className="absolute left-1/2 -translate-x-1/2 w-5 h-5 bg-blue-500 rounded-full border-4 border-white shadow z-20"></div>
        ...
        >
          <div className="bg-white/90 backdrop-blur-sm rounded-lg shadow-lg p-6 border-l-4 border-green-400">
  ...
  return (
    <div className="relative max-w-6xl mx-auto px-4 py-16 
      before:absolute before:top-0 before:bottom-0 before:left-1/2 
      before:w-1 before:-translate-x-1/2 before:bg-gray-300">

      {/* Experience */}
      <h2 className="text-4xl font-bold  mb-12 text-pink-500">Experience</h2>
      {experiences.map((exp, index) => renderTimelineCard(exp, index))}

      {/* Education */}
      <h2 className="text-4xl font-bold text-pink-500 mt-20 mb-12">Education</h2>
      {education.map((edu, index) => renderTimelineCard(edu, index))}
    </div>
  );
}
